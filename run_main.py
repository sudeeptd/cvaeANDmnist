...
def parse_args():
    ...
    parser.add_argument('--PMLR_n_img_x', type=int, default=90,
                        help='Number of images along x-axis')

    parser.add_argument('--PMLR_n_img_y', type=int, default=90,
                        help='Number of images along y-axis')
            ...
            if min_tot_loss > tot_loss or epoch+1 == n_epochs:
                ...
                if PMLR and epoch+1==n_epochs:
                    ...
                    for label in target_labels:
                        ...
                        PMLR.save_images(x__PMLR_img, name="/PMLR_epoch_%02d_%02d" % (epoch, label) + ".jpg",label=label)
